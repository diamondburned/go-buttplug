...
const (
	// MessageTypeBatteryLevelCmd is the type string for a [BatteryLevelCmdMessage].
	MessageTypeBatteryLevelCmd MessageType = "BatteryLevelCmd"
	// MessageTypeBatteryLevelReading is the type string for a [BatteryLevelReadingMessage].
	MessageTypeBatteryLevelReading MessageType = "BatteryLevelReading"
	...
	// MessageTypeRSSILevelCmd is the type string for a [RSSILevelCmdMessage].
	MessageTypeRSSILevelCmd MessageType = "RSSILevelCmd"
	// MessageTypeRSSILevelReading is the type string for a [RSSILevelReadingMessage].
	MessageTypeRSSILevelReading MessageType = "RSSILevelReading"
...
func (p *Payload) UnmarshalJSONFrom(decoder *jsontext.Decoder) error {
	...
	for {
		...
		for {
			...
			case MessageTypeBatteryLevelCmd:
				var msg BatteryLevelCmdMessage
				if err := json.UnmarshalDecode(decoder, &msg); err != nil {
					return fmt.Errorf("failed to unmarshal message of type %q: %w", key, err)
				}
				*p = append(*p, &msg)

			case MessageTypeBatteryLevelReading:
				var msg BatteryLevelReadingMessage
				if err := json.UnmarshalDecode(decoder, &msg); err != nil {
					return fmt.Errorf("failed to unmarshal message of type %q: %w", key, err)
				}
				*p = append(*p, &msg)
			...
			case MessageTypeRSSILevelCmd:
				var msg RSSILevelCmdMessage
				if err := json.UnmarshalDecode(decoder, &msg); err != nil {
					return fmt.Errorf("failed to unmarshal message of type %q: %w", key, err)
				}
				*p = append(*p, &msg)

			case MessageTypeRSSILevelReading:
				var msg RSSILevelReadingMessage
				if err := json.UnmarshalDecode(decoder, &msg); err != nil {
					return fmt.Errorf("failed to unmarshal message of type %q: %w", key, err)
				}
				*p = append(*p, &msg)
...
func (b *BatteryLevelCmdMessage) Type() MessageType {
	return MessageTypeBatteryLevelCmd
}

func (b *BatteryLevelCmdMessage) isMessage()       {}
func (b *BatteryLevelCmdMessage) isClientMessage() {}
...
func (b *BatteryLevelCmdMessage) LogValue() slog.Value {
	type raw BatteryLevelCmdMessage
	return slog.GroupValue(
		slog.String("type", "BatteryLevelCmd"),
		slog.Any("data", (*raw)(b)))
}

// Type returns [MessageTypeBatteryLevelReading].
func (b *BatteryLevelReadingMessage) Type() MessageType {
	return MessageTypeBatteryLevelReading
}

func (b *BatteryLevelReadingMessage) isMessage()       {}
func (b *BatteryLevelReadingMessage) isClientMessage() {}
...
func (b *BatteryLevelReadingMessage) LogValue() slog.Value {
	type raw BatteryLevelReadingMessage
	return slog.GroupValue(
		slog.String("type", "BatteryLevelReading"),
		slog.Any("data", (*raw)(b)))
}
...
func (r *RSSILevelCmdMessage) Type() MessageType {
	return MessageTypeRSSILevelCmd
}

func (r *RSSILevelCmdMessage) isMessage()       {}
func (r *RSSILevelCmdMessage) isClientMessage() {}
...
func (r *RSSILevelCmdMessage) LogValue() slog.Value {
	type raw RSSILevelCmdMessage
	return slog.GroupValue(
		slog.String("type", "RSSILevelCmd"),
		slog.Any("data", (*raw)(r)))
}

// Type returns [MessageTypeRSSILevelReading].
func (r *RSSILevelReadingMessage) Type() MessageType {
	return MessageTypeRSSILevelReading
}

func (r *RSSILevelReadingMessage) isMessage()       {}
func (r *RSSILevelReadingMessage) isClientMessage() {}
...
func (r *RSSILevelReadingMessage) LogValue() slog.Value {
	type raw RSSILevelReadingMessage
	return slog.GroupValue(
		slog.String("type", "RSSILevelReading"),
		slog.Any("data", (*raw)(r)))
}
